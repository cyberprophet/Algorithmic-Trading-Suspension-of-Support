namespace ShareInvest.TermsAndConditions
{
    public class Terms
    {
        public string Conditions
        {
            ...
            "‘서비스’라 함은 구현되는 단말기(PC, 휴대형단말기 등 각종 유무선 장치를 포함)와 상관없이\n‘회원’이 이용할 수 있는 도깨비방망이 관련 제반의 서비스를 의미합니다.\n" +
            ...
            "제 3 조 (이용약관의 효력 및 변경)" +
            "(1) 이 약관은 도깨비방망이를 통해 온라인으로 공시하고\n회원의 동의와 회사의 승낙으로 효력을 발생하며\n합리적인 사유가 발생할 경우 회사는 전자상거래등 에서의 소비자보호에관한법률, 약관의규제에관한법률, 전자거래기본법, 전자서명법, 정보통신망이용촉진등에관한법률, 방문판매등에관한법률, 소비자보호법 등 관련법을 위배되지 않는 범위 안에서 개정할 수 있습니다.\n" +
            ...
            "(3) 회사가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 도깨비방망이 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다.\n" +
            ...
            "(2) 이용계약에 대한 동의와 정보제공의 동의는 이용신청 당시 '동의함' 버튼을 누름으로써 의사표시를 합니다.\n" +
            "(3) 제휴사의 서비스를 통하여 회사에 대해 고객 정보 제공에 동의를 한 이용자는\n회사의 이용약관 및 회사의 개인정보취급방침에 동의한 것으로 간주하며\n제 7 조 및 개인정보 취급방침에 의해 보호, 사용되어집니다.\n" +
            ...
            "(4) ‘네이버아이디 등의 소셜로그인’을 이용하여 서비스를 이용할 경우, 회사는 각 소셜 사이트로부터\n'기본 정보’를 제공받아 당사의 정책 및 개인정보취급방침에 따라 저장/관리하며\n이에 대해 각 소셜 사이트가 사전에 회원들로부터 개인정보 제공 동의를 받고 있습니다.\n" +
        ...
        public string Rest
        {
            ...
            =
            "\n\n\n제 7 조 (개인정보의 보호 및 사용)\n" +
            "\n(1) 회사는 관계 법령이 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련 법령 및 회사의 개인정보 취급방침이 적용됩니다.\n" +
            ...
            "\n(2) 회사는 회원의 정보수집시 맞춤식 서비스를 비롯한 보다 더 향상된 양질의 서비스를 제공하기 위해 필요한 최소한의 정보를 유료 결제 시 수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 각 소셜에서 제공하는 사항으로 합니다.\n" +
            "\t- 휴대폰 번호\n" +
            "\t- 이메일주소\n" +
            "\t- 입금자명(무통장입금시)\n" +
            ...
            "\n(4) 회원은 언제든지 회사가 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정을 요구할 수 있으며 회사는 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다. 회원이 오류의 정정을 요구한 경우에는 회사는 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.\n" +
        ...
        public string Sentance
        {
            ...
            "\n\n\n\n\n제 4 장 서비스의 이용\n" +
            "\n\n\n제 11조 (서비스의 이용 시간)\n" +
            "\n(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다.\n\t단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시 중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시 중단은 도깨비방망이를 통해 사전에 공지합니다.\n" +
            ...
            "\n(4) 회사는 무료로 제공되는 서비스의 일부 또는 전부를 회사의 정책 및 운영의 필요상 수정, 중단, 변경할 수 있으며, 이에 대하여 관련법에 특별한 규정이 없는 한 ‘회원’에게 별도의 보상을 하지 않습니다.\n" +
            "\n\n\n제 12조(회원의 게시물 등)\n" +
            ...
            "\n\n\n\n\n제 5 장 계약의 해지 및 이용제한\n" +
            "\n\n\n제 15 조(계약해지)\n" +
            "\n(1) 회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 서비스 내의[회원정보] 메뉴를 이용해 회원탈퇴를 해야 합니다.\n" +

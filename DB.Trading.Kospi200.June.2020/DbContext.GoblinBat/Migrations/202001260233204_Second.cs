...
{
    partial class Second : DbMigration
    {
        public override void Up()
        {
            ...
            }).PrimaryKey(t => new { t.Code, t.Strategy, t.Assets, t.Time, t.Short, t.Long }).ForeignKey("dbo.Codes", t => t.Code, cascadeDelete: true).Index(t => t.Code);
        }

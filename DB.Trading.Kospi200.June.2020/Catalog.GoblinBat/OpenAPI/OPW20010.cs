...
namespace ShareInvest.Catalog
{
    public class OPW20010 : ScreenNumber, ITRs, IEnumerable
    {
        ...
        readonly string[] output = { "예탁총액", "예탁현금", "예탁대용", "증거금총액", "증거금현금", "증거금대용금", "주문가능총액", "주문가능현금", "주문가능대용금", "추가증거금총액", "추가증거금현금", "추가증거금대용금", "전일장종료예탁총액", "전일장종료예탁현금", "전일장종료예탁대용금", "인출가능총액", "인출가능현금", "인출가능대용금", "순자산금액", "익일예탁총액", "개장예탁총액", "선물정산차금", "선물청산손익", "선물평가손익", "선물약정금액", "옵션결제차금", "옵션청산손익", "옵션평가손익", "옵션약정금액" };
    }
}
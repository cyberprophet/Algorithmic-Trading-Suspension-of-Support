...
{
  public  class ConnectKosdaq150:Conceal
    {
        public static ConnectKosdaq150 Get()
        {
            if (api == null)
                api = new ConnectKosdaq150();
        ...
        private static ConnectKosdaq150 api;

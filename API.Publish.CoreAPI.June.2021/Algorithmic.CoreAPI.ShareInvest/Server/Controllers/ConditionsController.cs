...
namespace ShareInvest.Controllers
{
	...
	public class ConditionsController : ControllerBase
	{
		...
		public object GetContext(string key)
		{
			if (key.Length == 6)
			{
				var sc = context.Codes.AsNoTracking().SingleOrDefault(o => o.Code.Equals(key));
				...
				if (context.Group.AsNoTracking().Any(o => o.Code.Equals(key)) && context.Group.AsNoTracking().Single(o => o.Code.Equals(key)) is Models.Group group)
					return new Catalog.Models.Intro
					{
						...
						Title = group.Title,
						Index = group.Index,
						Theme = context.Theme.AsNoTracking().SingleOrDefault(o => o.Index.Equals(group.Index)).Name,
